...
import { Loader2, Search, ChevronDown, Send, Save, Info, Upload, FileVideo, X, Settings } from 'lucide-react';
            ...
            <div className="p-12 text-center space-y-4">
              <div className="flex justify-center">
                <div className="w-20 h-20 rounded-2xl bg-accent-green/20 flex items-center justify-center">
                  <FileVideo className="w-10 h-10 text-accent-green" strokeWidth={1.5} />
                </div>
              </div>
